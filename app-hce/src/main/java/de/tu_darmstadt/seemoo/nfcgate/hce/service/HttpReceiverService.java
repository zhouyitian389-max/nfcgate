...
import de.tu_darmstadt.seemoo.nfcgate.hce.security.AuthTokenProvider;
...
public class HttpReceiverService extends Service {
    ...
    public static final String PREF_AUTH_TOKEN_ENABLED = "pref_auth_token_enabled";
    ...
    private boolean startServer() {
        ...
        try {
            SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(this);
            boolean authTokenEnabled = sp.getBoolean(PREF_AUTH_TOKEN_ENABLED, true);
            server = new YitianHttpServer(this, port, AuthTokenProvider.getToken(this), authTokenEnabled);
