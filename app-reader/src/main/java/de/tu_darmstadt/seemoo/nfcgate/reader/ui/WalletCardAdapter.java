...
public class WalletCardAdapter extends RecyclerView.Adapter<WalletCardAdapter.ViewHolder> {
    ...
    public static class WalletCard {
        ...
        public WalletCard(CardBrandDetector.CardBrand brand, String last4) {
            this.brand = brand;
            this.last4 = last4;
        }
    }

    private final List<WalletCard> cards;

    public WalletCardAdapter(List<WalletCard> cards) {
        this.cards = cards;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        WalletCard card = cards.get(position);
